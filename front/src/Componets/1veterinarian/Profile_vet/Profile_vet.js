            ...
            <div className="containet" style={{ "margin-top": "100px", "margin-left": "30px" }}>
                ...
                <div className="left_side">
                    ...
                    <div className="contaner education">
                        <Link style={{ "margin-left": "130px", "background": "white", "color": "#ff6e01" }} className='btnn titleee' to={`/update_vet`}>Update</Link>
                        <br />
                        <br />
                    </div>
                </div>
