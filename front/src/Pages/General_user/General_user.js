    ...
    return (
        <>
            ...
            <section class="about" id="about">
                ...
                <h2 style={{ "margin-top": "120px", "margin-left": "35px" }} class="deco-title">care them</h2>
            ...
            <section class="about" id="about">
                ...
                <h2 style={{ "margin-top": "1300px", "margin-left": "35px" }} class="deco-title">Adopt me !</h2>
            ...
            <section class="about" id="about">
                ...
                <h2 style={{ "margin-top": "2260px", "font-size": "40px", "margin-left": "29px" }} class="deco-title">communication</h2>
            ...
            <section class="about" id="about">
                ...
                <h2 style={{ "margin-top": "2910px", "font-size": "90px", "margin-left": "35px" }} class="deco-title">cooperation</h2>
